package cn.createsoft.util.saltlib;

/**
 * Created by Lunatic on 12/5/16.
 */
...
public class AESCoder {
   ...
   public static void main(String[] args) throws Exception {
        ...
        System.out.println();
        byte[] encryptData = encrypt(data.getBytes(), k,"AES/CTR/NoPadding","1234567812345678".getBytes());
        System.out.println("加密后数据: byte[]:"+showByteArray(encryptData));
        //System.out.println("加密后数据: hexStr:"+Hex.encodeHexStr(encryptData));
        System.out.println();
        byte[] decryptData = decrypt(encryptData, k,"AES/CTR/NoPadding","1234567812345678".getBytes());
